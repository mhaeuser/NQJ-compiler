...
public class FileAnalysisTest {
    ...
    public void testChecker() throws Exception {
        ...
        if (parseSuccessMeansTestPasses && !analysis.getTypeErrors().isEmpty()) {
            //
            // CHANGE: Output all type errors.
            //
            for (TypeError typeError : analysis.getTypeErrors()) {
                System.err.println("Type error in " + file.getName() + ":" + typeError.getLine() + ": " + typeError.getMessage());
            }
            fail("Parser rejected (" + file.getName() + ":1), but should accept it.");
        }
    ...
    public static Collection<Object[]> data() {
        ...
        List.of("","/arrays","/classes").forEach(dir -> {
